...
class CreateShimmerLoadingScreen extends StatefulWidget {
  const CreateShimmerLoadingScreen({super.key});

  @override
  State<CreateShimmerLoadingScreen> createState() => _CreateShimmerLoadingScreenState();
}

class _CreateShimmerLoadingScreenState extends State<CreateShimmerLoadingScreen> {
