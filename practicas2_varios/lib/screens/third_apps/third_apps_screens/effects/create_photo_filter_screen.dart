...
class CreatePhotoFilterScreen extends StatefulWidget {
  const CreatePhotoFilterScreen({super.key});

  @override
  State<CreatePhotoFilterScreen> createState() => _CreatePhotoFilterScreenState();
}

class _CreatePhotoFilterScreenState extends State<CreatePhotoFilterScreen> {
  final _filters = [
    Colors.white,
    ...List.generate(
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      color: Colors.black,
      child: Scaffold(
        appBar: AppBar(title: const Text('Create a Photo Filter Carousel'),),
