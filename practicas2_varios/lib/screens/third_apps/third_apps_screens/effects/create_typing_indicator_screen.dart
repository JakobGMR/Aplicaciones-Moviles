...
class CreateTypingIndicatorScreen extends StatefulWidget {
  const CreateTypingIndicatorScreen({super.key});

  @override
  State<CreateTypingIndicatorScreen> createState() => _CreateTypingIndicatorScreenState();
}

class _CreateTypingIndicatorScreenState extends State<CreateTypingIndicatorScreen> {
