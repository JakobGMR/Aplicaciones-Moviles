...
class AnimatePropertiesContainerScreen extends StatefulWidget {
  ...
  @override
  State<AnimatePropertiesContainerScreen> createState() => _AnimatePropertiesContainerScreenState();
}

class _AnimatePropertiesContainerScreenState extends State<AnimatePropertiesContainerScreen> {
  double _width = 50;
  double _height = 50;
